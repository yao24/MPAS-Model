...
! temperature and humidity. NOTE: \! (1) All fluxes are positive downward,  \! (2) Here, tstar = (WT)/U*, and qstar = (WQ)/U*,  \! (3a) wind speeds should all be above a minimum speed (eg. 1.0 m/s). \!
! ASSUME:
